create table if not exists public.projects (
    ...
    image_details jsonb not null default '[]'::jsonb,
...
alter table public.projects add column if not exists image_details jsonb not null default '[]'::jsonb;
alter table public.projects add column if not exists cover_image text not null default '';
...
set images = array_replace(images, 'https://images.unsplash.com/photo-1600566753051-9c1c8b5f5d1c?auto=format&fit=crop&w=1200&q=85', 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1200&q=85'),
    image_details = replace(image_details::text, 'https://images.unsplash.com/photo-1600566753051-9c1c8b5f5d1c?auto=format&fit=crop&w=1200&q=85', 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1200&q=85')::jsonb
where title = 'Torre Eje' and is_example = true;
